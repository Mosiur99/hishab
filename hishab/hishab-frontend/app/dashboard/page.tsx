...
//   const [purchaseType, setPurchaseType] = useState<'CASH' | 'CARD' | 'MOBILE_BANKING' | 'BANK_TRANSFER'>('CASH');
...
//         } else {
//           console.log("No items found or error:", itemsResponse.message);
//           // Show user-friendly message if no items
//           if (itemsResponse.message.includes("No items found")) {
//             console.log("Database might be empty. Please run the SQL scripts to add test data.");
//           }
//         }

//         // Mock expenses data for demonstration
//         const mockExpenses: Expense[] = [
//           { id: 1, amount: 25.50, description: "Lunch", category: "Food", date: "2024-01-15", purchaseType: "CASH", costingType: "QUANTITY" },
//           { id: 2, amount: 15.00, description: "Coffee", category: "Food", date: "2024-01-15", purchaseType: "CARD", costingType: "QUANTITY" },
//           { id: 3, amount: 50.00, description: "Gas", category: "Transport", date: "2024-01-14", purchaseType: "CASH", costingType: "WEIGHT" },
//           { id: 4, amount: 1200.00, description: "Rent", category: "Housing", date: "2024-01-01", purchaseType: "BANK_TRANSFER", costingType: "QUANTITY" },
//           { id: 5, amount: 80.00, description: "Shopping", category: "Shopping", date: "2024-01-13", purchaseType: "MOBILE_BANKING", costingType: "QUANTITY" },
//         ];
...
//         setStats(prev => ({
//           ...prev,
//           todayTotal: prev.todayTotal + newExpense.amount,
//           monthTotal: prev.monthTotal + newExpense.amount,
...
//     }
//   }, [itemId, quantity, perUnitCost, totalCost, weight, perWeightCost, purchaseType, costingType, costingDate, isSubmitting, items, expenses]);
...
//               <p className="text-2xl font-bold text-gray-900">${stats.monthTotal.toFixed(2)}</p>
//             </div>
//           </div>
//         </div>
...
//           {expenses
//             .filter(expense => purchaseTypeFilter === 'ALL' || expense.purchaseType === purchaseTypeFilter)
//             .slice(0, 5)
//             .map((expense) => (
...
//                     {expense.costingType && ` • ${expense.costingType}`}
//                     {expense.purchaseType && ` • ${expense.purchaseType.replace('_', ' ')}`}
//                   </p>
//                 </div>
//               </div>
...
//                     {expense.purchaseType === 'CASH' && '💵'}
//                     {expense.purchaseType === 'CARD' && '💳'}
//                     {expense.purchaseType === 'MOBILE_BANKING' && '📱'}
//                     {expense.purchaseType === 'BANK_TRANSFER' && '🏦'}
//                     {' '}{expense.purchaseType.replace('_', ' ')}
//                   </p>
//                 )}
//               </div>
//             </div>
...
//               <div>
//                 <label htmlFor="purchaseType" className="label">Purchase Type *</label>
//                 <select
//                   id="purchaseType"
//                   className="input"
//                   value={purchaseType}
//                   onChange={(e) => setPurchaseType(e.target.value as 'CASH' | 'CARD' | 'MOBILE_BANKING' | 'BANK_TRANSFER')}
//                   required
//                 >
//                   <option value="CASH">Cash</option>
//                   <option value="CARD">Card</option>
